    ...
    <div className="flex flex-col font-sans min-h-screen text-gray-900">
      ...
      <div className="bg-red-600">
        <div className="container mx-auto">
          ...
          <h2 className="text-3xl font-bold text-white mt-8">Hvor meget strøm bruger hoppeborgene?</h2>
          <p className="text-lg text-white mt-2">De fleste hoppeborg kræver blot adgang til 1x 230v (2000W). Vi kommer selv med kabeltromle som kan nå de fleste distancer. Kontakt os venligst først hvis der er ekstra langt til strømudtag.</p>

          <h2 className="text-3xl font-bold text-white mt-8">Er hoppeborgene sikre at bruge?</h2>
